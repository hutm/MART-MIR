...
public class MartSuiteTest {
    ...
    private static String workingDirectoryFilePath;
    ...
    public static String getWorkingDirectoryFilePath() {
        if(workingDirectoryFilePath == null){
            setUpWorkingDirectory();
        }
        return workingDirectoryFilePath;
    }
}
