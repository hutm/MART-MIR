...
package org.mart.crs.model.htk.parser.beat;
...
public class BeatHTKParser extends ChordHTKParser {
    ...
    public void storeResults() {
        ...
        for (BeatStructure beatStructure : beatResults) {
            beatStructure.serializeIntoXML(String.format("%s/%s%s", parsedLabelsDir, beatStructure.getSongName(), Extensions.BEAT_EXT));
        }
    }
