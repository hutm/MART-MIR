...
import org.mart.crs.exec.operation.domain.BeatOperationDomain;
...
import static org.mart.crs.exec.scenario.stage.StageParameters.NOTHING_SYMBOL;
...
public class TrainingOnsetLanguageModelsOperation extends TrainingLanguageModelsOperation {
    ...
    protected void createLanguageModels() throws IOException {
        ...
        String command = "ngram-count -text " + textFilePath + " -order " + execParams.standardLmOrder + " -wbdiscount -lm " + (lmDir + File.separator + LMModelStandardVersion);
    ...
    public void parseLabelsToTextFile(String wavFileList, String outText, boolean isFactored) {
        ...
        LabelsSource labelsSource = new LabelsSource(Settings.labelsGroundTruthDir, true, "gt", Extensions.BEAT_EXTENSIONS);
    ...
    public void createText(List<String> labelFilePaths, String outFile) {
        ...
        try {
            ...
            for (String file : labelFilePaths) {
                ...
                float stretchStart = stretchCoeffForBeatLMBuildingStart;
                float stretchEnd = stretchCoeffForBeatLMBuildingEnd;
                ...
                for (float stretch = stretchStart; stretch <= stretchEnd; stretch += 0.02) {
                    ...
                    if (acceptedString || HelperFile.getExtension(file).equalsIgnoreCase(Extensions.BEAT_MAZURKA_EXT)) {
    ...
    protected boolean appendBuild(StringBuilder builder, BeatSegment beatSegment, double stretch) {
        ...
        return (duration <= BeatOperationDomain.minNimberOfFramesForBeatSegment || duration >= BeatOperationDomain.maxNimberOfFramesForBeatSegment);
    }
