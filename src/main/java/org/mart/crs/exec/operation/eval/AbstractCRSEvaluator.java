...
public abstract class AbstractCRSEvaluator {
    ...
    public void exportSummary(String outFileName){
        outFileName = outFileName.replaceAll(Extensions.TXT_EXT, String.format("%s%s", this.getClass().getName().substring(this.getClass().getName().lastIndexOf(".") + 1), Extensions.TXT_EXT));
        try {
