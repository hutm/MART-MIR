...
public class RecognizeConventionalVersionWithLMOperation extends RecognizeOperation {
    ...
    public void operate() {
        ...
        HelperFile.createFileList(extractedFeaturesDir, fileList, new ExtensionFileFilter(Extensions.LATTICE_EXT), false);
        List<String> latticeFilePathList = HelperFile.readTokensFromTextFile(fileList, 1);

        //Transform all lattices into FLM originalFormat     //TODO:refactoring
//        if (IS_FACTORED_LM) {
...
//                    HTKResultsParser.parseLM(outRescoredFile, recognizedFolder, false);
                    ...
                    if (isToPostProcessLabelsToOutputComplicatedChords) {
