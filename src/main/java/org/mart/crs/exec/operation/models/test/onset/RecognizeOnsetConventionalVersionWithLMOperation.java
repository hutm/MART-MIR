...
import org.mart.crs.model.htk.HTKLatticeTransformerBeats;
import org.mart.crs.model.htk.HTKResultsParserBeat;
...
public class RecognizeOnsetConventionalVersionWithLMOperation extends RecognizeOnsetOperation {
    ...
    public void operate() {
        ...
        for (String inLattice : latticeFilePathList) {
            ...
            command = "lattice-tool" + EXECUTABLE_EXTENSION + " -debug 0 -in-lattice " + inLattice + " -out-lattice " + outLattice + " -read-htk -write-htk -lm " + lmDir + File.separator + StageParameters.LMModelStandardVersion + " -htk-logbase 2.71828 -no-nulls -no-htk-nulls -order " + execParams.latticeRescoringOrder;
