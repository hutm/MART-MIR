 ...
 * @author: Hut
 */
public class SimpleScenarioBeatJump {

    public SimpleScenarioBeatJump() {
...
//            operation.setOperationType(OperationType.BEAT_OPERATION);
...
//                    Settings.gaussianNumber = gaussians;
//                    Settings.penalty = penalty;
//                    operation = new RecognizeBeatConventionalVersionWithLMOperation(Settings._workingDir);
//                    operation.setOperationType(OperationType.BEAT_OPERATION);
//                    scenario.addOperation(operation);
//                }
//            }
