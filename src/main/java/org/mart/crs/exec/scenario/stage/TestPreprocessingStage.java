 ...
 * @author: Hut
 */
public class TestPreprocessingStage extends AbstractStage implements ITrainTest {

    public TestPreprocessingStage(String parameterPrefix, AbstractStage childStage) {
        super(parameterPrefix, childStage);
        this.stageName = TEST_PREPROCESSING_STAGE_NAME;
        this.stageNumber = TEST_PREPROCESSING_STAGE_NUMBER;
    }
