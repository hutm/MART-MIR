...
public class HarmonicReassignedPeaksTuner extends F0PeaksTuner{
    ...
    protected void initialize() {
        ...
        this.spectrum = (ReassignedSpectrum) CoreElementsInitializer.initializeSpectrumWithExecParamsData(SpectrogramType.HARMONIC, audioReader.getSamples(), audioReader.getSampleRate(), ExecParams._initialExecParameters);
        spectrum.getMagSpec();
